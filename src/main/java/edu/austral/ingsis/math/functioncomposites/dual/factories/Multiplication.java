...
import edu.austral.ingsis.math.functioncomposites.dual.solvers.MultiplicationSolver;

public class Multiplication implements DoubleOperationFactory{
    @Override
    public DoubleOperation createDoubleOperation(Function function1, Function function2) {
        return new DoubleOperation(function1, function2, " * ", new MultiplicationSolver());
    }
}
