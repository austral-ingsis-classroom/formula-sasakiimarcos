...
import edu.austral.ingsis.math.functioncomposites.binary.solvers.AdditionSolver;

public class Addition implements BinaryOperationFactory {
    @Override
    public BinaryOperation createDoubleOperation(Function function1, Function function2) {
        return new BinaryOperation(function1, function2, " + ", new AdditionSolver());
    }
}
